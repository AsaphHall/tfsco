 ...
 * [tfsco.yml](tfsco.yml)
     * Determines how your purl.obolibrary.org/obo/tfsco/ redirects will be handled
     ...
     * Paste in the contents of [tfsco.yml](tfsco.yml)
 ...
 * [tfsco.md](tfsco.md)
     ...
     * Paste in the contents of [tfsco.md](tfsco.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*

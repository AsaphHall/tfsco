...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/tfsco-odk.yaml)
...
```
  <uri name="http://purl.obolibrary.org/obo/tfsco/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/tfsco-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/tfsco/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/tfsco.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
